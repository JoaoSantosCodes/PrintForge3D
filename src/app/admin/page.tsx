    ...
    <div className="space-y-8 animate-in fade-in duration-300">
        ...
        <div className="flex items-center gap-3">
          <Link href="/admin/pedidos">
            <Button variant="secondary">
              <ShoppingBag className="w-4 h-4 text-teal-400" /> Ver Pedidos ({totalPedidos})
            </Button>
          </Link>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 relative overflow-hidden group">
          ...
          <div className="text-4xl font-extrabold text-amber-400">{pedidosPendentes}</div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 relative overflow-hidden group">
          ...
          <div className="text-4xl font-extrabold text-cyan-400">{pedidosEmProducao}</div>
          <p className="text-xs text-slate-500 mt-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        <Link href="/admin/pedidos" className="block group">
          <div className="bg-slate-900 border border-slate-800 hover:border-amber-500/40 rounded-2xl p-6 transition-all hover:shadow-xl hover:shadow-amber-500/5">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 rounded-xl bg-amber-500/10 text-amber-400">
                <ShoppingBag className="w-6 h-6" />
              </div>
              <span className="text-2xl font-bold text-slate-200">{totalPedidos}</span>
            </div>
        ...
        <Link href="/admin/impressoras" className="block group">
          <div className="bg-slate-900 border border-slate-800 hover:border-teal-500/40 rounded-2xl p-6 transition-all hover:shadow-xl hover:shadow-teal-500/5">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 rounded-xl bg-teal-500/10 text-teal-400">
                <Printer className="w-6 h-6" />
              </div>
              <span className="text-2xl font-bold text-slate-200">{totalImpressoras}</span>
            </div>
            <h3 className="font-semibold text-slate-100 group-hover:text-teal-400 transition-colors">
              Impressoras
            </h3>
            <p className="text-xs text-slate-400 mt-1">
        ...
        <Link href="/admin/filamentos" className="block group">
          <div className="bg-slate-900 border border-slate-800 hover:border-cyan-500/40 rounded-2xl p-6 transition-all hover:shadow-xl hover:shadow-cyan-500/5">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 rounded-xl bg-cyan-500/10 text-cyan-400">
                <Boxes className="w-6 h-6" />
              </div>
              <span className="text-2xl font-bold text-slate-200">{totalFilamentos}</span>
            </div>
        ...
        <Link href="/admin/tintas" className="block group">
          <div className="bg-slate-900 border border-slate-800 hover:border-pink-500/40 rounded-2xl p-6 transition-all hover:shadow-xl hover:shadow-pink-500/5">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 rounded-xl bg-pink-500/10 text-pink-400">
                <Palette className="w-6 h-6" />
              </div>
              <span className="text-2xl font-bold text-slate-200">{totalTintas}</span>
            </div>
            <h3 className="font-semibold text-slate-100 group-hover:text-pink-400 transition-colors">
              Tintas & Pintura
            </h3>
            <p className="text-xs text-slate-400 mt-1">
        ...
        <Link href="/admin/pecas" className="block group">
          <div className="bg-slate-900 border border-slate-800 hover:border-purple-500/40 rounded-2xl p-6 transition-all hover:shadow-xl hover:shadow-purple-500/5">
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 rounded-xl bg-purple-500/10 text-purple-400">
                <Layers className="w-6 h-6" />
              </div>
              <span className="text-2xl font-bold text-slate-200">{totalPecas}</span>
            </div>
