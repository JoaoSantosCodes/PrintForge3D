    ...
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-800 pb-6">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-100 tracking-tight flex items-center gap-3">
            <FileText className="w-8 h-8 text-teal-400" /> Relatórios Mensais de Operação
          </h1>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2 text-slate-300 text-sm font-semibold">
          <Calendar className="w-4 h-4 text-teal-400" /> Selecione o Período de Análise:
        </div>
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <select
            ...
            className="bg-slate-950 border border-slate-800 rounded-xl px-4 py-2 text-sm text-slate-100 font-medium focus:outline-none focus:border-teal-500"
          >
            {MESES.map((m, idx) => (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 relative overflow-hidden group">
          ...
          <div className="text-3xl font-extrabold text-teal-400">{totalPecasProduzidas}</div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 space-y-4">
        <h3 className="text-lg font-bold text-slate-100 flex items-center gap-2.5">
          <Award className="w-5 h-5 text-amber-400" /> Destaque de Produção do Mês
        </h3>
          ...
          return (
            <div className="p-4 bg-slate-950 border border-slate-800/80 rounded-2xl flex items-center justify-between">
              <div>
                ...
                <h4 className="text-xl font-extrabold text-teal-300 mt-0.5">
                  {p.nome}
                </h4>
              </div>
