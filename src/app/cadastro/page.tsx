...
export default function CadastroPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col justify-center py-8 sm:py-12 px-4 sm:px-6 lg:px-8 text-slate-900 dark:text-slate-100 relative transition-colors">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center space-y-3">
        ...
        <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900 dark:text-slate-100">
          Criar Conta no <span className="text-teal-500 dark:text-teal-400">PrintForge 3D</span>
        </h2>
      ...
      <div className="mt-6 sm:mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 py-6 sm:py-8 px-5 sm:px-10 shadow-xl dark:shadow-2xl rounded-3xl space-y-6 transition-colors">
          {successMsg ? (
            <div className="text-center space-y-4 py-4 animate-in fade-in duration-300">
              ...
              <div className="space-y-1.5">
                <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100">Solicitação Enviada!</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start gap-2.5 pt-1">
                <input
                  ...
                  className="mt-0.5 w-4 h-4 rounded border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 text-teal-500 focus:ring-teal-500 focus:ring-offset-slate-900"
                />
                <label htmlFor="acceptedTerms" className="text-xs text-slate-600 dark:text-slate-400 leading-tight select-none">
                  Li e concordo com os{" "}
                  <Link href="/termos" target="_blank" className="text-teal-600 dark:text-teal-400 hover:underline font-medium">
                    Termos de Uso
                  </Link>{" "}
                  e a{" "}
                  <Link href="/privacidade" target="_blank" className="text-teal-600 dark:text-teal-400 hover:underline font-medium">
