...
import { Users, Search, CheckCircle2, XCircle, Clock, ShieldAlert, Store, UserCheck, Shield, Trash2, Loader2, AlertTriangle } from "lucide-react";
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-800 pb-6">
        <div>
          ...
          <p className="text-slate-400 text-xs sm:text-sm mt-1">
            Visualização global, aprovação de cadastros, gerenciamento de permissões e controle de acesso.
          </p>
        </div>

        <div className="flex items-center gap-3">
          <div className="px-3.5 py-1.5 rounded-xl bg-purple-500/10 border border-purple-500/30 text-purple-300 text-xs font-bold flex items-center gap-2">
            <Shield className="w-4 h-4 text-purple-400" /> Total: {usuarios.length} usuários
          </div>
        </div>
      </div>
