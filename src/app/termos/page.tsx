      ...
      <div className="max-w-4xl mx-auto space-y-8 relative z-10">
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Termos de Uso</h1>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 md:p-8 space-y-6 text-sm text-slate-700 dark:text-slate-300 leading-relaxed shadow-lg dark:shadow-2xl transition-colors">
          <section className="space-y-2">
            <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 flex items-center gap-2">
              <CheckCircle2 className="w-4 h-4 text-teal-500 dark:text-teal-400" /> 1. Aceitação dos Termos
            </h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 flex items-center gap-2">
              <FileText className="w-4 h-4 text-cyan-500 dark:text-cyan-400" /> 2. Orçamentos e Fabricação 3D
            </h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 flex items-center gap-2">
              <AlertCircle className="w-4 h-4 text-amber-500 dark:text-amber-400" /> 3. Cancelamento e Devolução
            </h2>
            <p>
